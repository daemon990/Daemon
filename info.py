...
PICS = (environ.get('PICS', 'https://graph.org/file/ab65553699eb86e849a6b.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/ab65553699eb86e849a6b.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/b2af355932abb7f66fb13.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")
DPIC = (environ.get("DPIC", "https://graph.org/file/132e3fd5b18d9285dac57.jpg")).split() 
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5374926375 809614790 5226707402 1717639829 5570696493 6290585476 2107606665 6969268010 5586146331').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'JwJpMyTrUoMptmoacQytUNC3qRm2')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK',True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zyFSc2GkuDNjNDJl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TMA_MOVIE_UPDATES')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/TMA_MOVIE_UPDATES')
